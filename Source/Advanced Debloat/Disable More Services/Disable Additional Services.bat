...
echo. 
echo.
echo.                                              [A] Disable ALL Services Below                [B] Enable  
echo.                                              [C] Disable Unnecessary Services              [D] Enable  
echo.                                              [E] Disable Windows Update/Store Services     [F] Enable  
echo.                                              [G] Disable Remote Services                   [H] Enable  
echo.                                              [I] Disable Printer Services                  [J] Enable 
echo.                                              [K] Disable Bluetooth Services                [L] Enable 
echo.                                              [M] Disable Wifi Services *ETHERNET ONLY*     [N] Enable 
echo.                     
echo.
...
echo Press 0 and hit ENTER to go back to process lowering!
set /p example=
if %example% == 0 goto disableportidle
if %example% == 1 goto 1
if %example% == 2 goto 2
if %example% == 3 goto 3
if %example% == 4 goto 4
